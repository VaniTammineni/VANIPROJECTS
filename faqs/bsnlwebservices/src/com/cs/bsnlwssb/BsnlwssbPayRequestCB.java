...
public class BsnlwssbPayRequestCB implements Serializable{
	
	private String UserId="",Password="";
	
	private String strTransNo="",strMobileNo="",strPayMode="";
	private String strAccountType="",strRecptNo="",strBillNo="",strUniqId="",strSsaCode="",strOldTranno="",strRecptOldNo="";
	...
	public String getStrRecptOldNo() {
		return strRecptOldNo;
	}
	public void setStrRecptOldNo(String strRecptOldNo) {
		this.strRecptOldNo = strRecptOldNo;
	}
	public String getStrOldTranno() {
		return strOldTranno;
	}
	public void setStrOldTranno(String strOldTranno) {
		this.strOldTranno = strOldTranno;
	}
