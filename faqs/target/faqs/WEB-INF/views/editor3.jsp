 ...
 var base = '';
   function funImage(input){
    ...
    function searchViaAjax() {
    	 ...
    	 var i = val.indexOf("<");
    	  var res = val.substring(0, i);
    	  alert("after editing"+" "+res);
    	
//          formData.append('file', $('input[type=file]')[0].files[0]);
//          alert("form data " + formData);

         formData.append("qustn",document.getElementById("question").value);
        // formData.append("answers",document.getElementById("editor").value);
         formData.append("ans",base);
   ...
   /* function searchViaAjax() {
    	...
    	var ans= document.getElementById("editor").innerHTML
    	var qustn= document.getElementById("question").value;
    	alert(qustn);
...
<!--   </div> -->
	...
	<form id="formidss" action="qustns.htm" method="post" enctype="multipart/form-data">
	<div>
	<label for="questn" >Question
	<input type="text" id="question" name="question" placeholder="Enter Your Question" style="width:75%"></label>
	</div>
	<div>
    ...
    <div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">
      ...
      <div class="btn-group">
        ...
        <input type="file" id="file" name="file" onchange="funImage(this);" data-role="magic-overlay" data-target="#pictureBtn" data-edit="insertImage" />
      </div>
      <div class="btn-group">
