...
//     	var tempId = id;
    	var ans= document.getElementById("uAnswer").innerHTML
    	var qustn= document.getElementById("uQuestion").value;
//     	var bytes = [];
...
//     	}
    	...
    	document.getElementById("formidss").method = 'POST';
   	 	document.getElementById("formidss").action = "unixqustns.htm";
...
<!--   </div> -->
	...
	<input type="text" id="uQuestion" name="uQuestion" placeholder="Enter Your Question" style="width:75%"></label>
	</div>
	<div>
	<label for="ans" id="ans">Answer</label>
	<div id="alerts"></div>
    <div class="btn-toolbar" data-role="editor-toolbar" data-target="#uAnswer">
      <div class="btn-group">
  ...
  $(function(){
    function initToolbarBootstrapBindings() {
      ...
      if ("onwebkitspeechchange"  in document.createElement("input")) {
        var editorOffset = $('#uAnswer').offset();
        $('#voiceBtn').css('position','absolute').offset({top: editorOffset.top, left: editorOffset.left+$('#uAnswer').innerWidth()-35});
      } else {
        $('#voiceBtn').hide();
      }
	};
	...
	$('#uAnswer').wysiwyg({ fileUploadError: showErrorAlert} );
